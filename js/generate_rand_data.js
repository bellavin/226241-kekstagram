...
(function () {
  ...
  window.generateData = function (numOfElements) {
    ...
    for (var i = 0; i < numOfElements; i++) {
      var shuffledomments = window.shuffleArray(COMMENTS); // Перетряхиваем массив комментариев
      var currentComments = window.sliceArray(shuffledomments, MIN_COMMENTS, MAX_COMMENTS); // Забираем несколько из массива
